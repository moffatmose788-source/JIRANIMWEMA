...
import { MOCK_CONTRIBUTIONS, MOCK_MEMBERS } from '@/lib/mockData';
...
export default function ContributionsPage() {
  ...
  const filtered = MOCK_CONTRIBUTIONS.filter((c) => {
    const matchSearch =
    ...
    <DashboardLayout title="Contributions" subtitle="Track and manage member contributions">
      <div className="p-4 sm:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: 'Total Collected', value: formatCurrency(MOCK_CONTRIBUTIONS.reduce((s, c) => s + c.amount, 0)), icon: TrendingUp, color: 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400' },
            { label: 'This Month', value: formatCurrency(MOCK_CONTRIBUTIONS.filter((c) => c.month === 6 && c.year === 2026).reduce((s, c) => s + c.amount, 0)), icon: Calendar, color: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' },
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <Button variant="outline" size="sm" onClick={() => toast.info('Export feature coming soon')} className="gap-1.5">
